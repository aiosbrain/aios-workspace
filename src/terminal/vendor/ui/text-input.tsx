...
export const TextInput = ({
  ...
  }, [cursorOffset, cursorOrigin, displayValue, setCursorPosition, useNativeCursor]);
  ...
  const renderValue = () => {
    ...
    const highlighted = sliceGraphemes(displayValue, cursorOffset - pasteWidth, cursorOffset);
    const cursorChar =
