...
export type TerminalStatus = "error" | "info" | "neutral" | "pending" | "success" | "warning";
...
export const resolveStatusSymbol = (unicode: boolean, status: TerminalStatus): string =>
...
export const toAsciiComponentText = (value: string): string =>
  Array.from(value, (character) => asciiComponentCharacters[character] ?? character).join("");
