...
**`docs/brain-api.md` is the single pinned contract (document revision **1.21**, member-facing API **1.21**, internal gateway **1.10**, major `/api/v1`)** between this toolkit and
