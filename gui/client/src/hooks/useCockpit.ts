...
import type { CommsChannel } from "../components/comms/channel-filter";

export type ViewKey =
  "chat" | "comms" | "tasks" | "review" | "maturity" | "cost" | "loop" | "settings";
...
export function useCockpit() {
  ...
  const [commsChannel, setCommsChannel] = useState<CommsChannel>("all");
