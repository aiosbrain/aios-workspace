...
supported setup does not fit (for example, a Linux laptop). Native Windows shells are not
supported; run AIOS through WSL until Windows Task Scheduler support ships.
