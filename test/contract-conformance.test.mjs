...
// The codebase-payload contract (brain-api 1.23 / AIO-1011). Unlike the item-payload reference
...
test("codebase payload contract is content-addressed and declares a scanner minimum", () => {
  ...
  // (see docs/brain-api.md v1.23): commit distance is meaningless across branches, unavailable
