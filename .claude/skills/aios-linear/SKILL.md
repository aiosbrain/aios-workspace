...
$LIN remove-relation AIO-73 AIO-75 blocks  # remove only the directional AIO-73 → AIO-75 blocker
$LIN remove-relation AIO-73 AIO-75 related # remove the pair's related relation (either direction)
