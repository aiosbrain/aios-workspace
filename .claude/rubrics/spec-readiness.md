...
| SR17 | Increment-bounded — the spec is one reviewable PR. Blocks when it enumerates many tasks AND spans many unrelated top-level surfaces (mixed-concern, oversized); a single signal is advisory | deterministic | yes |
