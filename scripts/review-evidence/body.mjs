/**
 * review-evidence/body.mjs — the vendored review-body validator (AIO-777).
 *
 ...
 *
 * Only change here: `visibleMarkdown`, `validateCandidateShaBinding` and `SHA_PATTERN` carry an
 * `export` keyword so the sibling selection layer can reuse them. No body was touched, and the
 * parity corpus compares `validateReviewBody` behaviour, which is unaffected.
 */
...
export function validateCandidateShaBinding(verification, candidateShas) {
