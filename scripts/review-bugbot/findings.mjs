...
// Severity rank, canonical casing, and the structural finding matchers all live in the core
// leaf scripts/severity.mjs (AIO-594 — the devtools consolidator/build loop must reach them
// without importing this stays-core module); re-exported here so this file's documented
// surface is unchanged. The matcher regex dialect (including the AIO-239 markdown-emphasis
// tolerance) is documented at its canonical home in severity.mjs.
import { SEVERITY_RANK, canonicalSeverity } from "../severity.mjs";
export { SEVERITY_RANK, canonicalSeverity };
export { hasFindingsAtOrAbove, hasCriticalOrHighFindings } from "../severity.mjs";
