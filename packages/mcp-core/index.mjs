...
export const TOOLS = [
  ...
  },
  {
    ...
    async handler(args, client) {
      const data = await client.searchEvidence(args.query, args.project, args.limit ?? 8);
      // Already bounded structurally by the API/client; preserve compact JSON without asContent's slicing.
